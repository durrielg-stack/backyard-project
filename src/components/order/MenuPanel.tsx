...
import {
  MENU_GROUPS as GROUPS,
  type MenuGroupId as GroupId,
} from "@/lib/menuGroups";
...
export default function MenuPanel({
  ...
  useEffect(() => {
    function onKey(e: KeyboardEvent) {
      ...
      if (tag === "INPUT" || tag === "TEXTAREA") {
        ...
        if (["Enter", "s", "h"].includes(e.key.toLowerCase()))
      ...
      if (["Enter", "s", "h", "S", "H"].includes(e.key))
        onKeyboardShortcut?.(e.key);
    }
  ...
  const subCats = activeGroup.cats.filter(
